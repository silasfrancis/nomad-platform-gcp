...
default = {
    ...
    # Manually seeded, shared across both envs (Flag 3) — read by
    # vault/secrets.tf as external data sources, not generated by
    # any Terraform resource.
    "gemini-api-key"    = { labels = { purpose = "ai-agent", tier = "operator" } }
    "slack-webhook-url" = { labels = { purpose = "ai-agent", tier = "operator" } }
